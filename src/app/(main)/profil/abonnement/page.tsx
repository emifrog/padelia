...
export default function AbonnementPage() {
  return (
    <Suspense fallback={<div className="flex h-40 items-center justify-center"><Loader2 className="h-6 w-6 animate-spin" /></div>}>
      <AbonnementContent />
    </Suspense>
  );
}
...
function AbonnementContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Current status */}
      {isPremium && (
        <div className="flex items-center gap-3 rounded-xl bg-gradient-to-r from-amber-50 to-yellow-50 p-4 dark:from-amber-950/20 dark:to-yellow-950/20">
          <Crown className="h-8 w-8 text-amber-500" />
          <div>
            <p className="font-semibold text-amber-700 dark:text-amber-400">Premium actif</p>
            {premiumExpires && (
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl border p-4">
          <div className="mb-3 flex items-center justify-between">
            <div>
              <h3 className="font-semibold">{PLANS.free.name}</h3>
          ...
          <div className="mb-3 flex items-center justify-between">
            <div>
              <div className="flex items-center gap-1.5">
                <h3 className="font-semibold">{PLANS.premium_monthly.name}</h3>
        ...
        <div className="relative rounded-xl border p-4">
          ...
          <div className="mb-3 flex items-center justify-between">
            <div>
              <h3 className="font-semibold">{PLANS.premium_yearly.name}</h3>
              <p className="text-2xl font-bold">
